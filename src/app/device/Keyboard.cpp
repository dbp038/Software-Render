...
bool __cdecl Keyboard::IsKeyDown( Keys key ) const {
	return pImpl->IsKeyDown( key );
}

bool __cdecl Keyboard::IsKeyJustPressed( Keys key ) const {
	return tracker.IsKeyPressed( key );
}

bool __cdecl Keyboard::IsKeyJustReleased( Keys key ) const {
