...
/* Slightly altered version of DirectXTK Keyboard class
*		- Removed DirectX namespace
*		- Removed UWP, XBOne & WinRT stuff
*		- Added IsKeyDown, IsKeyJustPressed & IsKeyJustReleased for easier access
*/
...
#pragma prefast(suppress: 26495, "Reset() performs the initialization")
	...
	bool __cdecl IsKeyJustPressed( Keys key ) const;
	bool __cdecl IsKeyJustReleased( Keys key ) const;
